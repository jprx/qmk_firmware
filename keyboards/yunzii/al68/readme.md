...
My minimal AL68 setup for Mac.
Modified from [Yunzii's repo](https://github.com/yunziikeyboard/qmk_firmware).

Usage:

1. `make yunzii/al68:jprx:flash`
2. Plug keyboard in while holding down Escape
